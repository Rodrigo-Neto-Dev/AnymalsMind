...
ds_list_add(menu, "New Game", "Load Game", "Config", "Credits", "Exit Game");	// the menu items, add or remove items to customize
...
// text variables
// title
title_text = "Anymal Mind";	// the title of the menu
